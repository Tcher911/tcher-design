...
**Output**: A design brief that can be handed off to /tcher craft, or directly to /tcher for freeform implementation. When visual direction probes are used, the images are supporting artifacts, not the primary output.
