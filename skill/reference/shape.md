...
**Output**: A design brief that can be handed off to {{command_prefix}}tcher craft, or to {{command_prefix}}tcher idea for freeform implementation. When visual direction probes are used, the images are supporting artifacts, not the primary output.
