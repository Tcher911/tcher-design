 ...
 *
 * .env is loaded from the repo root (copied from tcher-evals). Tests
 ...
 * Override with TCHER_SKILL_BEHAVIOR_MODELS=claude-foo,gpt-bar.
 */
export const DEFAULT_MODELS = ['claude-sonnet-4-6', 'gpt-5.5', 'gemini-3.1-flash-lite'];

export function resolveModelList() {
  const override = process.env.TCHER_SKILL_BEHAVIOR_MODELS;
